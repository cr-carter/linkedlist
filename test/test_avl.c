...
{
    puts("\n");
    printf("Testing avl_create_tree...\n");
    tree_t *p_test = NULL;
...
{
    puts("\n");
    printf("Testing avl_clear_tree...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    int test5 = 5;

    avl_insert(p_test, &test5);
...
{
    puts("\n");
    printf("Testing avl_destroy_tree...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    TEST_ASSERT_NOT_NULL(p_test);
...
{
    puts("\n");
    printf("Testing avl_delete_node...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    int test5 = 5;
    int test3 = 3;
    bool check = false;
...
void test_avl_insert(void)
{
    ...
    puts("avl_insert(p_tree, &test5), with test5 not already in tree, should return true");
    check = avl_insert(p_test, &test5);
    TEST_ASSERT_EQUAL(1, avl_size_of_tree(p_test));
    TEST_ASSERT_EQUAL(true, check);

    puts("avl_insert(p_tree, &test5), with test5 already in tree, should return false");
    check = avl_insert(p_test, &test5);
    TEST_ASSERT_EQUAL(1, avl_size_of_tree(p_test));
    TEST_ASSERT_EQUAL(false, check);

    puts("avl_insert(p_tree, &test7), with test7 not already in tree, should return true, checking size should "
         "return 2");
    check = avl_insert(p_test, &test7);
    TEST_ASSERT_EQUAL(2, avl_size_of_tree(p_test));
    TEST_ASSERT_EQUAL(true, check);

    puts("avl_insert(p_tree, &test9), with test9 not already in tree, should return true, checking size should "
         "return 3, the root should be 7 after rotation");
    check = avl_insert(p_test, &test9);
...
{
    puts("\n");
    printf("Testing avl_minimum_value...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    int test5 = 5;
    int test3 = 3;
    int test7 = 7;
...
{
    puts("\n");
    printf("Testing avl_maximum_value...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    int test5 = 5;
    int test3 = 3;
    int test7 = 7;
...
{
    puts("\n");
    printf("Testing avl_size_of_tree...\n");
    tree_t *p_test = avl_create_tree(int_comp, NULL);
    int test5 = 5;
    int test3 = 3;
    int test7 = 7;
