 ...
 * through the sll_* API; do not access or allocate sll_t directly.
 */
 ...
 *
 * Called by sll_destroy() on each element's data pointer. Provide
 ...
 */
typedef int (*sll_cmp_f)(const void *, const void *);
 ...
 */
typedef void (*sll_iter_f)(void *);

/**
 * @brief Allocate and initialize an empty list. O(1)
 *
 * @return Pointer to a new sll_t on success, or NULL on allocation failure.
 */
 ...
 * Zero-based indexing from the head; negative indices are invalid and return NULL.
 *
