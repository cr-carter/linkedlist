...
#define UNITY_SET_DETAIL(d1)                                           \
    ...
    {                                                                  \
        UNITY_CLR_DETAILS();                                           \
        UnityPushDetail(                                               \
            UNITY_DETAIL_D1, (UNITY_DETAIL_VALUE_TYPE)(d1), __LINE__); \
    } while (0)
#define UNITY_SET_DETAILS(d1, d2)                                      \
    do                                                                 \
    {                                                                  \
        ...
        UnityPushDetail(                                               \
            UNITY_DETAIL_D1, (UNITY_DETAIL_VALUE_TYPE)(d1), __LINE__); \
        UnityPushDetail(                                               \
            UNITY_DETAIL_D2, (UNITY_DETAIL_VALUE_TYPE)(d2), __LINE__); \
    } while (0)
...
#define UNITY_TEST_ASSERT_FLOAT_NOT_WITHIN( \
    delta, expected, actual, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_FLOAT(expected, actual, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
#define UNITY_TEST_ASSERT_FLOAT_ARRAY_WITHIN(             \
    delta, expected, actual, num_elements, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
...
#define UNITY_TEST_ASSERT_GREATER_THAN_FLOAT(threshold, actual, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_FLOAT( \
    threshold, actual, line, message)             \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
#define UNITY_TEST_ASSERT_LESS_THAN_FLOAT(threshold, actual, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
#define UNITY_TEST_ASSERT_LESS_OR_EQUAL_FLOAT( \
    threshold, actual, line, message)          \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
...
#define UNITY_TEST_ASSERT_DOUBLE_NOT_WITHIN( \
    delta, expected, actual, line, message)  \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_DOUBLE(       \
    expected, actual, num_elements, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
#define UNITY_TEST_ASSERT_GREATER_THAN_DOUBLE( \
    threshold, actual, line, message)          \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_DOUBLE( \
    threshold, actual, line, message)              \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
#define UNITY_TEST_ASSERT_LESS_THAN_DOUBLE(threshold, actual, line, message) \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
#define UNITY_TEST_ASSERT_LESS_OR_EQUAL_DOUBLE( \
    threshold, actual, line, message)           \
    UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrDouble)
